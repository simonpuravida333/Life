...
// TIP: create shapes in Illustrator, Figma or another vector program, save as SVG and open it in a text editor. Edit the file in the vector graphics program to see on the fly how the SVG is constructed in the text editor. You can directly copy it over to your HTML space to see it take effect in your app.
